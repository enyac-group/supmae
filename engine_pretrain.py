...
def train_one_epoch_supmae(model: torch.nn.Module,
    ...
    for data_iter_step, (samples, labels) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
            rec_loss, _, _, logits = model(samples, mask_ratio=args.mask_ratio)
            cls_loss = criterion(logits / temperature, labels) * cls_loss_ratio
